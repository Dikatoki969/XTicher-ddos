...
JANGAN DI LEAK YAH DEK INI PUNYA @FLAYINGSORYOU`);
 console.log(`node xin.js target/web time/Second rate trhead proxy.txt ©FLAYINGSORYOU`);
 process.exit();}
 const headers = {};
