...
const secureOptions =
 ...
 if (process.argv.length < 7){console.log(`node vxn.js target/web time/Second rate trhead proxy.txt ©FLAYINGSORYOU`); process.exit();}
...
if (cluster.isMaster) {
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log(` FLAYINGSORYOU DDOS ATTACK`.red.bold);
    console.log("═════════════════════════════════════════════════════════════".gray);
    ...
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log(` [!] Attack by flayingstress launched successfully`.brightRed);
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log("FLAYING DDOS | HIGH REQ/SEC UAS CUSTOM".yellow.bold);
